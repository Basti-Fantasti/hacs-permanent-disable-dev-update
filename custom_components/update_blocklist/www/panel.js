 ...
 */
const O = globalThis, k = O.ShadowRoot && (O.ShadyCSS === void 0 || O.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, X = Symbol(), j = /* @__PURE__ */ new WeakMap();
let rt = class {
  constructor(t, e, s) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ht, defineProperty: at, getOwnPropertyDescriptor: lt, getOwnPropertyNames: ct, getOwnPropertySymbols: dt, getPrototypeOf: pt } = Object, M = globalThis, I = M.trustedTypes, $t = I ? I.emptyScript : "", ut = M.reactiveElementPolyfillSupport, S = (r, t) => r, R = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? $t : null;
      break;
...
g.elementStyles = [], g.shadowRootOptions = { mode: "open" }, g[S("elementProperties")] = /* @__PURE__ */ new Map(), g[S("finalized")] = /* @__PURE__ */ new Map(), ut?.({ ReactiveElement: g }), (M.reactiveElementVersions ??= []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const D = globalThis, V = (r) => r, H = D.trustedTypes, q = H ? H.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, tt = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, et = "?" + _, _t = `<${et}>`, m = document, w = () => m.createComment(""), C = (r) => r === null || typeof r != "object" && typeof r != "function", z = Array.isArray, ft = (r) => z(r) || typeof r?.[Symbol.iterator] == "function", T = `[ 	
\f\r]`, E = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Z = /-->/g, J = />/g, f = RegExp(`>|${T}(?:([^\\s"'>=/]+)(${T}*=${T}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), K = /'/g, F = /"/g, st = /^(?:script|style|textarea|title)$/i, At = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), mt = At(1), y = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), G = /* @__PURE__ */ new WeakMap(), A = m.createTreeWalker(m, 129);
function it(r, t) {
...
class x {
  ...
  _$AI(t, e = this) {
    t = v(this, t, e), C(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== y && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : ft(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
wt?.(P, x), (D.litHtmlVersions ??= []).push("3.3.2");
const Ct = (r, t, e) => {
...
const Pt = L.litElementPolyfillSupport;
Pt?.({ LitElement: b });
...
let Q = class extends b {
  render() {
    return mt`<div>Update Blocklist — loading…</div>`;
  }
};
Q = Ot([
  xt("update-blocklist-panel")
], Q);
export {
  Q as UpdateBlocklistPanel
};
